...
TRAIN_SCRIPT="${SCRIPT_DIR}/monolingual_130m.sh"
if [[ "$goldfish" == "True" ]]; then
  TRAIN_SCRIPT="${SCRIPT_DIR}/monolingual_130m_gold.sh"
fi
...
VOCABS=(262144) #8192 16384 32768 49152 65536 81920 98304 114688 
