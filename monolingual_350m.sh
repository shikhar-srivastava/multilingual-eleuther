...
# Usage:
#   bash monolingual_350m.sh <norm_type> <monolingual_dataset> <vocab_size> <tokenizer_type> [post_num] [master_port] [num_epochs]
# Example:
#   bash monolingual_350m.sh pre fineweb_eng 32768 bpe_unscaled 6 29510
#   bash monolingual_350m.sh pre fineweb2_amh 8192 bpe_unscaled 6 29510 20
...
echo "Training 350M with lr=$learning_rates, norm=$norm_type, dataset=$monolingual_dataset, tok=${tokenizer_type}/${vocab_size}, epochs=${num_epochs} on 4 GPUs"
