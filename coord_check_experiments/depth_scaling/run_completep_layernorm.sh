#!/bin/bash
#
# Depth scaling experiment for CompleteP with LayerNorm
...
BASE_DIR="coord_check_experiments/depth_scaling/completep_layernorm"
...
echo "Running CompleteP depth scaling (LayerNorm: LayerNorm + SwiGLU + RoPE)..."
echo ""
...
echo ""
echo "Depth scaling experiment complete (LayerNorm)!"
