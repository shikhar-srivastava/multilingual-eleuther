#!/bin/bash
#
# Depth scaling experiment for CompleteP with GELU
# (RMSNorm + GELU + RoPE)
...
BASE_DIR="coord_check_experiments/depth_scaling/completep_gelu"
...
echo "Running CompleteP depth scaling (GELU: RMSNorm + GELU + RoPE)..."
echo ""
...
echo ""
echo "Depth scaling experiment complete (GELU)!"
