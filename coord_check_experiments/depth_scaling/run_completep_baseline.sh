#!/bin/bash
#
# Depth scaling experiment for CompleteP baseline
# (RMSNorm + SwiGLU + RoPE - LLAMA standard)
#
# Tests depth scaling with CompleteP α=1.0
...
BASE_DIR="coord_check_experiments/depth_scaling/completep_baseline"
...
echo "Running CompleteP depth scaling (baseline: RMSNorm + SwiGLU + RoPE)..."
echo ""
...
echo ""
echo "Depth scaling experiment complete (baseline)!"
