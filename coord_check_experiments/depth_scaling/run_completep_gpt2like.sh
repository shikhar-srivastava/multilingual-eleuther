#!/bin/bash
#
# Depth scaling experiment for CompleteP with GPT-2-like architecture
...
BASE_DIR="coord_check_experiments/depth_scaling/completep_gpt2like"
...
echo "Running CompleteP depth scaling (GPT-2-like: LayerNorm + GELU + Learned)..."
echo ""
...
echo ""
echo "Depth scaling experiment complete (GPT-2-like)!"
