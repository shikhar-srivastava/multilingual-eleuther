#!/bin/bash
#
# Depth scaling experiment for CompleteP with GELU (STABLE VERSION)
# (RMSNorm + GELU + RoPE)
#
# Stability improvements:
# 1. Reduced learning rate for deeper models
# 2. Less aggressive depth_alpha_exp (0.5 instead of 1.0)
# 3. Gradient clipping
...
BASE_DIR="coord_check_experiments/depth_scaling/completep_gelu_stable"
...
echo "Running CompleteP depth scaling (GELU STABLE: RMSNorm + GELU + RoPE)..."
echo ""
...
for DEPTH in "${DEPTHS[@]}"; do
    ...
    echo "  Using LR=${LR} for depth=${DEPTH}"
...
echo ""
echo "Depth scaling experiment complete (GELU STABLE)!"
