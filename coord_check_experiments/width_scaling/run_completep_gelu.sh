#!/bin/bash
#
# Width scaling experiment for CompleteP with GELU only
# (RMSNorm + GELU + RoPE)
#
# This isolates the effect of GELU vs SwiGLU on activation drift.
...
BASE_DIR="coord_check_experiments/width_scaling/completep_gelu"
...
echo "Running CompleteP width scaling with GELU only..."
...
echo ""
echo "Width scaling experiment complete (GELU only)!"
