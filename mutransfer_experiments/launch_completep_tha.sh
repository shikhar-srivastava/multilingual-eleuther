...
#
# Usage:
#   bash launch_completep_tha.sh [EXPERIMENT_TYPE] [OUT_DIR] [GPU_ID] [SINGLE_VALUE]
#
# Examples:
...
#   bash launch_completep_tha.sh depth out 0 4      # Run depth=4 only on GPU 0
#   bash launch_completep_tha.sh depth out 1 8      # Run depth=8 only on GPU 1
#   nohup bash launch_completep_tha.sh depth out 0 4 > logs/tha_d4.log 2>&1 &
