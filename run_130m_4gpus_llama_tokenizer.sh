...
echo "Using meta-llama/Llama-2-7b-hf tokenizer"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --nproc_per_node 4 --master_port=$MASTER_PORT torchrun_main.py \
    ...
    --run_name "130m_res_${norm_type}_lr${learning_rates}_llama_tokenizer_track_bytes" \
    --save_dir "130m_res_${norm_type}_lr${learning_rates}_llama_tokenizer_track_bytes" \
    --track_activations \
    --activation_track_every 1000 \
